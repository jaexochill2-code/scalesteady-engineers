...
const categories = [
  {
    ...
    href: "/renegaderoofing/readiness",
    icon: Server,
  ...
  },
  {
    ...
    description: "Access segmented partner & referral databases, track counts, and upload new leadlists via the secure importer.",
    href: "/renegaderoofing/leads",
    icon: Users,
...
export default function RenegaderoofingHomePage() {
  return (
