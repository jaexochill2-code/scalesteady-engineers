...
export default function Footer() {
  return (
    <footer className="w-full bg-brand-charcoal text-brand-cashmere border-t border-brand-pistachio/20">
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <form className="flex max-w-md items-center border-b border-brand-pistachio/30 pb-2">
              <input 
                type="email" 
              ...
              <button 
                type="submit" 
                className="font-sans text-xs font-semibold uppercase tracking-wider text-brand-green hover:text-white transition-colors"
              >
                Sign Up
              </button>
            </form>
          ...
          <div className="grid grid-cols-2 gap-8 lg:col-span-3 sm:grid-cols-4">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-brand-cashmere/75 font-sans">
                <li><Link href="/services" className="hover:text-white transition-colors">Horizontal Scaling</Link></li>
                <li><Link href="/process" className="hover:text-white transition-colors">Warmup Protocol</Link></li>
                <li><Link href="/process" className="hover:text-white transition-colors">Data Mining</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-brand-cashmere/75 font-sans">
                <li><a href="#" className="hover:text-white transition-colors">ADV Form Part 2</a></li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-brand-cashmere/75 font-sans">
                <li><Link href="/team" className="hover:text-white transition-colors">The Engineers</Link></li>
        ...
        <div className="mt-16 pt-8 border-t border-brand-pistachio/10 space-y-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center text-xs text-brand-cashmere/40 font-mono pt-4 border-t border-brand-pistachio/5">
            <span>© {new Date().getFullYear()} SCALESTEADY, INC. ALL RIGHTS RESERVED.</span>
          ...
          <p className="font-sans text-[10px] leading-relaxed text-brand-cashmere/35 max-w-6xl">
            ScaleSteady operates as an elite B2B systems engineering firm. We design, host, and operate B2B outbound infrastructure. Lead delivery is dependent on target demographic volume, market conditions, and client offer positioning. We are fiduciaries of your outbound brand health and do not engage in spam-bot practices.
          </p>
        </div>
